  ...
  <div class="subtitle">Parse PDFs, extract tables/charts, preview markdown, and download outputs.</div>
        ...
        with gr.Tab("DocRes Image Restoration"):
            with gr.Row():
                ...
                docres_task_standalone = gr.Dropdown(["appearance", "dewarping", "deshadowing", "deblurring", "binarization", "end2end"], 
                                                   value="appearance", label="Restoration Task")
                docres_device_standalone = gr.Dropdown(["auto", "cuda", "cpu"], value="auto", label="Device")
            ...
            # Single page selector for both PDFs (above the PDFs)
            with gr.Row():
            ...
            def render_pdf_pages(pdf_path, max_pages=10):
            ...
            def update_docres_page_selector(original_pdf, enhanced_pdf):
            ...
            def display_docres_page(page_selector, pages_data, pdf_path):
            ...
            def sync_page_changes(page_selector, original_pages, enhanced_pages, original_pdf_path, enhanced_pdf_path):
            ...
            def run_docres_restoration(pdf_file, task, device, dpi, save_enhanced, save_images):
...
<div class="card">
  ...
  <ul>
    ...
    <li>Use <strong>DocRes Image Restoration</strong> for scanned documents, low-quality PDFs, or documents with shadows/distortion.</li>
